...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002046402859').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1002015639006') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '6725874739') # give your force subscribe group id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://priyanshukumawat2021:<RLNrf8F70KdrE75p>@cluster0.2tndnik.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Shortlink Info
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.publicearn.io')
SHORTLINK_API = environ.get('SHORTLINK_API', '4356debf16d2ff8e1f495a2b6983caf308f9a0da')
